...
const technologies = {
  ...
  tools: [
    ...
    },
    {
      name: "Visual Studio",
      icon: DiVisualstudio,
      color: "group-hover:text-[#5C2D91]",
      desc: "IDE Profesional",
    },
    {
      name: "Android Studio",
          ...
          {technologies[activeTab as keyof typeof technologies].map(
            (tech, index) => (
              <motion.div
                ...
                className="group relative bg-black/40 border border-zinc-800 hover:border-zinc-600 p-4 rounded-xl flex items-center gap-4 cursor-default overflow-hidden transition-all hover:bg-zinc-900/60"
              >
                ...
                <div
                  className={`p-3 rounded-lg bg-zinc-900 border border-zinc-800 ${tech.color} text-zinc-500 transition-colors duration-300 group-hover:bg-black`}
                >
                  <tech.icon size={24} />
                </div>
