...
const CircuitTimeline = dynamic(
  () => import("@/components/sections/CircuitTimeline"),
  {
    loading: () => <LoadingSpinner />,
    ssr: false,
  },
...
const SimpleCard = memo(
  ({
    ...
    return (
      <div
        className={`relative rounded-2xl bg-zinc-900/90 backdrop-blur-xl border border-white/5 hover:border-emerald-500/30 transition-colors ${className}`}
      >
        {children}
      </div>
    );
              ...
              <div className="relative z-10 p-6 md:p-16">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-12 gap-6">
                  ...
                  <div className="text-left md:text-right flex flex-row md:flex-col gap-4 md:gap-0">
                    <div className="text-zinc-500 font-mono text-[10px] md:text-xs">
                      LATENCY: 12ms
                    </div>
                    <div className="text-zinc-500 font-mono text-[10px] md:text-xs">
                      ENCRYPTION: AES-256
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  <div className="lg:col-span-2 space-y-6">
                    ...
                    <SimpleCard className="w-full">
                      <a
                        href="mailto:josemajimenezrodriguez8@gmail.com"
                        className="block w-full p-6 group"
                      >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <SimpleCard className="sm:col-span-2">
                        <a
                          href="tel:+34722625288"
                          className="block w-full p-4 flex flex-row items-center justify-between gap-3 group"
                        >
                          <div className="flex items-center gap-3">
                      ...
                      <SimpleCard>
                        <a
                          ...
                          className="block w-full h-full p-4 flex flex-col md:flex-row items-center justify-center gap-2 md:gap-3 group"
                        >
                          <FaLinkedin
                            size={24}
                            className="text-zinc-500 group-hover:text-[#0077b5] transition-colors"
                          />
                          <span className="font-bold text-xs md:text-sm text-zinc-400 group-hover:text-white">
                            LINKEDIN
                          </span>
                        </a>
                      </SimpleCard>
                      ...
                      <SimpleCard>
                        <a
                          href="https://github.com/Josemajr6/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="block w-full h-full p-4 flex flex-col md:flex-row items-center justify-center gap-2 md:gap-3 group"
                        >
